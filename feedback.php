  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:orange">Online Examination System</span></h4>
      </div>
...
<div class="col-md-10">
<a href="mailto:manoharmkt.182@gmail.com" style="color:#000000">Mail Now</a><br /><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="https://www.linkedin.com/in/mkthakur04/" style="color:#202020; font-family:'typo' ; font-size:18px" target="_blank" title="Find on Facebook">Manohar Kumar Thakur</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 827160**82</h4>
		<h4 style="font-family:'typo' ">manoharmkt.182@gmial.com</h4>
